...
* Support for Wordpress v4.2.2

= 1.0.9 =
*Release Date - 3rd March, 2015*

* Bugfixes (wp admin asset loading, php compatibility fix)

= 1.0.8 =
*Release Date - 12th February, 2015*

* Fixed a compatibility issue affecting PHP version <=5.3
...
* Fixed an issue in com.followistic.php
